<footer class="container-fluid">
   <div class="row bg-info">
      <div class="col-md-12  footer">
         <a href="mailto:oderinloanuoluwapo@gmail.com"><img src="images/email.png"></a>
         <a href="https://github.com/AnuOderinlo" target="_blank"><img src="images/github.png" target="_blank"></a>
         ...
         <p>&copy;Anuoluwapo Oderinlo, <?php $thisYear = date("Y"); echo($thisYear); ?></p>
      </div>
   </div>
</footer> 
